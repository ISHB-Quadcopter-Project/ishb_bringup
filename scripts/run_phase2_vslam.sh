...
source ~/ishb_ws/vslam_ws/devel/setup.bash --extend      # <-- added: puts voxel_slam on the path
source ~/ishb_ws/ishb_ws/devel/setup.bash --extend
roslaunch ishb_bringup phase2_system.launch lidar_type:=mid360 odom_source:=vslam
